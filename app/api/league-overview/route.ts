...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    // Top11 wg obstawy — front domyślnie pokazuje 6, z opcją rozwinięcia do pełnych 11
    // (patrz StatsSection).
    ...
    // kolejce — pokazuje, kto zyskał przewagę dzięki nietypowemu wyborowi. Top11 wg punktów —
    // front domyślnie pokazuje 6, z opcją rozwinięcia do pełnych 11 (patrz StatsSection).
